...
constants.define(exports, {
    ...
    " end as trip_status, "+
    " trip.trip_id, trip.user_id, trip.property_id, trip.host_id, trip.checkin_date, trip.checkout_date, trip.no_of_guests, trip.trip_approved_time, "+
    ...
    FETCH_HOST_RESERVATIONS: "select * from airbnb.trip where property_id IN (?) and trip_status='COMPLETED'"
});