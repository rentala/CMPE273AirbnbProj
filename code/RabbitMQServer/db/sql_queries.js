...
constants.define(exports, {
    ...
    FETCH_BILLING_DTLS:"SELECT trip.user_id,trip.property_id,trip.property_name,billing.billing_id,trip.trip_price,trip.checkin_date,trip.checkout_date,trip.no_of_guests FROM airbnb.trip ,airbnb.billing WHERE trip.trip_id = 1 and trip.trip_id = billing.trip_id and billing.bill_status = 'CREATED';",
    ...
    FETCH_USER_TRIP_DETAILS : "SELECT trip.trip_id as trip_id,trip.user_id as user_id,trip.property_id as property_id,trip.host_id as host_id,trip.checkin_date as checkin_date,trip.checkout_date as checkout_date,trip.no_of_guests as no_of_guests,trip.trip_status as trip_status,trip_price,property_name, (select b.billing_id from airbnb.billing b where b.trip_id = trip.trip_id) as billing_id" + " from airbnb.trip trip  where trip.user_id=?;",
